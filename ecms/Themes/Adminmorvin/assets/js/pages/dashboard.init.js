...
options = {
    fill: {colors: ["#525ce5"]},
    series: [70],
    chart: {type: "radialBar", width: 65, height: 65, sparkline: {enabled: !0}},
...
(chart = new ApexCharts(document.querySelector("#list-chart-1"), options)).render();
options = {
    fill: {colors: ["#23c58f"]},
    series: [80],
    chart: {type: "radialBar", width: 65, height: 65, sparkline: {enabled: !0}},
...
(chart = new ApexCharts(document.querySelector("#list-chart-2"), options)).render(), $("#world-map-markers").vectorMap({
    map: "world_mill_en",
