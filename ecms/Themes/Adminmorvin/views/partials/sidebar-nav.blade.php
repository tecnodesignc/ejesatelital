...
<div class="vertical-menu">
    ...
    <div data-simplebar class="h-100">
        ...
        <div class="user-sidebar text-center">
            <div class="dropdown">
                <div class="user-img">
                    <img src="{{$user->present()->gravatar()}}" alt="" class="rounded-circle">
                    <span class="avatar-online bg-success"></span>
                </div>
                <div class="user-info">
                    @if($user->present()->fullname() != ' ')
                        <h5 class="mt-3 font-size-16 text-white">{{$user->present()->fullname()}}</h5>
                        <span class="font-size-13 text-white-50">{{$user->roles()->first()->name}}</span>
                    @else
