...
@section('content-header')
    <h1>
        ...
        {{ $module->getLowerName() }} <small>{{ trans('workshop::modules.module') }}</small>
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">{{ trans('workshop::modules.viewing module') }} {{ $module->getLowerName() }}</li>
    </ol>
@stop
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <div class="box-tools pull-right">
                        <?php $status = $module->enable() ? 'disable' : 'enable'; ?>
                        <button class="btn btn-box-tool jsPublishAssets" data-toggle="tooltip"
                            ...
                            <?php $routeName = $module->enable() ? 'disable' : 'enable' ?>
                        {!! Form::open(['route' => ["admin.workshop.modules.$routeName", $module->getName()], 'method' => 'post']) !!}
                            <button class="btn btn-box-tool" data-toggle="tooltip" type="submit"
                                ...
                                <i class="fa fa-toggle-{{ $module->enable() ? 'on' : 'off' }}"></i>
