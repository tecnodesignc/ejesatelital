...
trait CanPublishConfiguration
{
    ...
    public function publishConfig($module, $fileName)
    {
        ...
        $this->mergeConfigFrom($this->getModuleConfigFilePath($module, $fileName), strtolower("encore.$module.$fileName"));
        $this->publishes([
            $this->getModuleConfigFilePath($module, $fileName) => config_path(strtolower("encore/$module/$fileName") . '.php'),
        ], 'config');
    }
