...
class CityTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //$province = $this->provinceSearch($cities[0]["province_iso_2"]);

        foreach ($cities as $key => $item)
            if ( !isset($province->iso_2) || $city['province_iso_2'] != $province->iso_2) $province = $this->provinceSearch($item["province_iso_2"]);
