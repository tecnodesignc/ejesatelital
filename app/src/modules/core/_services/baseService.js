...
import {remember} from '../_plugins/remember'
import {helper} from '../_plugins/helper'
import cache from '../_plugins/cache'
import config from '../_config/master/index'
...
export default {
  ...
  create(configName, data) {
    return new Promise((resolve, reject) => {
      ...
      //Request
      axios.post(urlApi, {attributes: data}).then(async response => {
